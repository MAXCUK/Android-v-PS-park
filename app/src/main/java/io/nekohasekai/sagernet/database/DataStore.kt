...
object DataStore : OnPreferenceDataStoreChangeListener {
    ...
    var xboardEmail by configurationStore.string(Key.XBOARD_EMAIL) { "" }
    var xboardPanelName by configurationStore.string(Key.XBOARD_PANEL_NAME) { "星隧互联" }
    var xboardLastGroupId by configurationStore.long(Key.XBOARD_LAST_GROUP_ID)
    var xboardLastSyncAt by configurationStore.long(Key.XBOARD_LAST_SYNC_AT)
