...
object Key {
    ...
    const val XBOARD_EMAIL = "xboardEmail"
    const val XBOARD_PANEL_NAME = "xboardPanelName"
    const val XBOARD_LAST_GROUP_ID = "xboardLastGroupId"
    const val XBOARD_LAST_SYNC_AT = "xboardLastSyncAt"
